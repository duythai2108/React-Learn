...
const CardTailwind = (props) => {
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute w-[calc(100%-36px)] left-2/4 -translate-x-2/4 translate-y-2/4 bottom-0 bg-white z-10 rounded-[20px] p-5">
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-x-3">
            <img
              className="w-[30px] h-[30px] object-cover rounded-[100px] flex-shrink-0"
              src="https://cdn.dribbble.com/users/2400293/screenshots/16527147/media/f079dc5596a5fb770016c4ea506cd77b.png?compress=1&resize=1000x750&vertical=top"
              alt=""
            />
            <span className="font-light text-base text-[#333333]">
              @zndrson
            </span>
          </div>
        ...
        <div className="flex justify-between items-center">
          <h3 className="font-bold text-lg">Cosmic Perspective</h3>
