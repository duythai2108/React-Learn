...
// loading skeleton -> thu vien loading
  ...
  return (
    <div className="p-10">
      <div className="w-full max-w-[500px] mx-auto mb-20">
        <input
          type="text"
          className="w-full p-5 rounded-lg border border-purple-200 shadow-[0px_0px_0px_3px_rgba(125,_106,_255,_0.2)]"
  ...
  return (
    <div className="bg-white p-3 rounded-2xl shadow-sm flex flex-col">
      ...
      <div className="p-7 flex-1 flex flex-col">
        <h3 className="text-lg text-black font-semibold mn-4">
...
const MovieItem = ({ data }) => {
  ...
  return (
    <div className="bg-white p-3 rounded-2xl shadow-sm flex flex-col">
      ...
      <div className="p-7 flex-1 flex flex-col">
        <h3 className="text-lg text-black font-semibold mn-4">{data.title}</h3>
        <p className="text-[#999] text-sm mb-6 !leading-loose">
          {data.overview}
        </p>
        <div className="flex items-center gap-x-3 mt-auto">
